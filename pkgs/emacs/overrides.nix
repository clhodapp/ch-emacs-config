...
self: super: {
  ...
  #
  # A second carried fix, in the elisp this time: dakra/ghostel#676.
  #
  ...
  #
  # Neither patch touches `src' or `version', so `evil-ghostel' below still
  # builds from the unpatched source; it has no `posn-col-row' call.
  ghostel =
    let
